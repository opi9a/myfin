...
def test_main_seq(new_project_fx):
    ...
    #-------------------------------------------------------------------------
    print(sep+'-- 0. SETTING UP')

    #-------------------------------------------------------------------------
    print(sep+'-- 0.1 reading in the seed_df')
    ...
    #-------------------------------------------------------------------------
    print(sep+'-- 0.2 reading in the db csvs')
    ...
    #-------------------------------------------------------------------------
    print(sep+'-- 0.3 checking file structure')
    ...
    for acc in os.listdir():
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + ']i. Look for prep.py and execute if present')
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + ']ii. Load new tx csvs and concat, using pandas')
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + '] iii. Format and structure the csv using parser')
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + ']iv. Check balance continuum and duplicates in'
                                                           ' aggregated txs')
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + ']v. Append to prev_txs.csv, net of any overlap')
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + ']vi. Compute the target accounts for new items')
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + ']vii. Append any new fuzzy matches or unknowns to'
                                            ' corresponding db')
        ...
        #----------------------------------------------------------------------
        print(sep+'[' + acc + ']viii. Append any new txs to tx_db')
    ...
    #-------------------------------------------------------------------------
    print(sep+'-- saving dbs to disk (tx, fuzzy, unknown only)')
